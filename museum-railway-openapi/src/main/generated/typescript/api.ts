...
export const LocationsResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        apiLocationGet: async (operatorId?: string | null, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const LocationsResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiLocationGet(operatorId?: string | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<MuseumLocation>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiLocationGet(operatorId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['LocationsResourceApi.apiLocationGet']?.[index]?.url;
...
export class LocationsResourceApi extends BaseAPI {
     ...
     */
    public apiLocationGet(operatorId?: string | null, options?: RawAxiosRequestConfig) {
...
export const ManagementResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiManageReloadDataPost: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ManagementResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiManageReloadDataPost(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiManageReloadDataPost(options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ManagementResourceApi.apiManageReloadDataPost']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export class ManagementResourceApi extends BaseAPI {
     ...
     */
    public apiManageReloadDataPost(options?: RawAxiosRequestConfig) {
...
export const OperatorsResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiOperatorGet: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const OperatorsResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiOperatorGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<MuseumOperator>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiOperatorGet(options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['OperatorsResourceApi.apiOperatorGet']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export class OperatorsResourceApi extends BaseAPI {
     ...
     */
    public apiOperatorGet(options?: RawAxiosRequestConfig) {
