...
dependencies {
    ...
    implementation("events.boudicca:eventdb-openapi:0.5.0-SNAPSHOT")
    implementation("events.boudicca:semantic-conventions:0.5.0-SNAPSHOT")
    implementation("events.boudicca:eventcollector-client:0.5.0-SNAPSHOT")
