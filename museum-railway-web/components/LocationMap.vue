...
<template>
  <!-- :use-global-leaflet="false" because of https://github.com/vue-leaflet/vue-leaflet/issues/278#issuecomment-1448388783 -->
  <LMap class="h-full w-full map-container" ref="locationMap" :use-global-leaflet="false" :center="DEFAULT_CENTER"
    :zoom="DEFAULT_ZOOM">
