...
const root: MessageTokenSections.Root = {
...
const text: MessageTokenSections.Text = {
    fontSize: '1rem',
    fontWeight: '500',
    sm: {
        fontSize: '0.875rem'
...
const closeButton: MessageTokenSections.CloseButton = {
    width: '2rem',
    height: '2rem',
    borderRadius: '50%',
    focusRing: {
...
const closeIcon: MessageTokenSections.CloseIcon = {
    size: '1rem',
    sm: {
        size: '0.875rem'
    },
...
const outlined: MessageTokenSections.Outlined = {
    root: {
        borderWidth: '1px'
    }
};

const simple: MessageTokenSections.Simple = {
    content: {
        padding: '0'
    }
};

const colorScheme: MessageTokenSections.ColorScheme = {
    light: {
        info: {
            background: "{sky.500}",
